...
As we will see shortly, this is not just a sufficient condition, but indeed a necessary one. Before we do so, we will need to take a slightly different angle on greedy policy behaviour - that of operator theory. 
