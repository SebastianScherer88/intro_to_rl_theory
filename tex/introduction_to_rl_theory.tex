...
\begin{proof}
	...
	\[
		\begin{array}{rll}
			\mathbb{E}_{s \sim P_s}[V^{\pi_l}(s)] & = & \sum_s P_s V^{\pi_l}(s) \\
				...
				& = & \mathbb{E}_{s_t \sim P_{s_t}, a_t \sim \pi_u(s_t,\cdot)}[Q^{\pi_l}(s_t,a_t)].
		\end{array}
	\]
	...
	\[
		\begin{array}{rll}
			& & \mathbb{E}_{a_t \sim \pi_u}[r_t | s_t = s] + \gamma \mathbb{E}_{s_t,a_t \sim P_s^{1 * \pi_u}, \pi_u(s_t,\cdot)}[Q^{\pi_l}(s_t,a_t)] \\
				 & = & \mathbb{E}_{a_t \sim \pi_u}[r_t | s_t = s] + \gamma \mathbb{E}_{s_t,a_t \sim P_s^{1 * \pi_u}, \pi_u(s_t,\cdot)}[r_{t+1} + \gamma V^{\pi_l}(s_{t+2})] \\
				 & = & \mathbb{E}_{a_t}[r_t | s_t = s] + \gamma \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[r_{t+1} + \gamma V^{\pi_l}(s_{t+2}) | s_t = s] \\
				& = & \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[r_t + \gamma r_{t+1} | s_t = s] + \gamma^2 \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[V^{\pi_l}(s_{t+2}) | s_t = s].
		\end{array}
	\]
	...
	\[
		\begin{array}{rll}
			& & \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[r_t + \gamma r_{t+1} | s_t = s] + \gamma^2 \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[V^{\pi_l}(s_{t+2}) | s_t = s] \\
			& \le & \mathbb{E}_{a_t,a_{t+1} \sim \pi_u}[r_t + \gamma r_{t+1} | s_t = s] + \gamma^2 \mathbb{E}_{a_t,a_{t+1} \sim \pi_u} [\mathbb{E}_{a_{t+2} \sim \pi_u}[Q^{\pi_l}(s_{t+2},a_{t+2})] | s_t = s]
		\end{array}
	\]
\end{proof}
